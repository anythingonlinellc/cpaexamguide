...
"Section layout",
"Choose between two different display modes for this section.",
...
"Team Member Image.",
"Role",
"Short description of this team member.",
"Add one or more links for this member.",
"Add Link",
"facebook",
"Use this block to add a new team member.",
"Last year stats",
"Choose between two different section layout types.",
"Featured first statistic",
"Font type",
"Choose between two different font types (only applies to 'columns' layout).",
"Themed",
"Section image.",
"Use this block to add a Stats section.",
"Statistic",
"Number",
"A number representing your statistic.",
"120",
"A text describing this statistic.",
"Employees",
"Color of the number.",
"Use this block to add a new statistic.",
"Our services",
"Button url",
"Button text",
...
"Recent Work",
"Add a recent work block.",
"Recent Posts",
"Add a Recent Posts section showing posts.",
"Use this block to add a Pricing section.",
"Premium",
"Specify whether this pricing table should be featured.",
"Plan",
"Pricing plan title.",
"Lite",
"Plan price.",
...
"Choose between 2 and 3 columns layout.",
"Use lightbox",
"If set to yes, instead of going to the single project, featured image will be opened in lightbox instead.",
"Add a Portfolio section showing projects.",
"Partners",
"Use this block to add a Partners block.",
"Partner",
"Optional link for the partner logo.",
"Use this block to add a new partner.",
"Panels",
"Use this block to add a Panels section.",
"Panel",
"Panel Icon.",
"Panel title.",
"Use this block to add a new panel.",
"Icons",
"Highlight title.",
"Add one or more icon.",
"Add Icon",
"ion-social-facebook-outline",
"Add an Icons section.",
"Highlight",
"Highlight subtitle.",
"Section height",
"Height of this section.",
"Text alignment",
"Text alignment of this section.",
...
"Contact Options",
"Pin title",
"Title of the text displayed when map pin is clicked.",
"Pin description",
"Text displayed when map pin is clicked.",
"Add a Contact section.",
"Call To Action",
"Call To Action text",
"Text displayed in Call To Action block.",
"We work for you with you",
"Text for optional button. Leave empty to not use teh button.",
"Url button will link to.",
"Open in new window",
"Should the url be opened in new window?",
"Font size",
"Two different layouts for Call To Action module are available, main difference is in font appearance and button placement.",
"Add a Call To Action section.",
"Add a Blog section showing posts.",
"About",
"Our company background",
"Select a gallery to be used in a slider for this section.",
"Add an About section.",
"Well",
"Add a well",
"Text displayed inside well.",
"Well size",
"Select a well size.",
"Progress Bar",
"Add a progress bar",
...
"Width",
"Width of the progress bar (number only).",
"Color scheme",
...
"64px",
"128px",
"Choose between several available icon sizes.",
"Select button color scheme.",
"Mini",
"Select a button color scheme.",
"Alert",
"Add an alert",
"Text displayed inside an alert.",
"Read more",
"Android",
"Apple",
"Bitcoin",
...
"Full width",
"Choose between two body widths.",
"Custom Colors",
...
"Centered logo",
"Detailed",
"Choose between multiple header designs.",
"Header text",
"Add one or text snippets displayed at the top left area of your Detailed header.",
"Add Text",
"Lorem ipsum",
"Add one or more social network icons to the top of your Detailed header.",
"Social Network Name",
"Displayed below the location icon in the footer.",
"Email address",
"Email address displayed below the envelope icon in footer.",
"Phone number",
"Displayed below the phone icon in the footer.",
"Copyright",
"This is the footer copyright message.",
"Splash",
"Choose between two different splash types.",
"Layout type",
"Choose between two different image splash types.",
"Simple tagline",
"Multiple taglines",
"Background Image",
"Upload image displayed in the background of the splash area.",
"Gallery used for splash area. Captions can be added when editing that gallery.",
"Text used as a splash title.",
"Headlines",
"Add one or headlines displayed on top of the splash image.",
"Add Headline",
"Headline",
"Show sidebar",
"Choose whether sidebar should be displayed or not.",
"If you liked what you saw hire us",
"Background color of the block",
"Subtitle of the slide (used only in splash).",
"Text of the button (used only in splash).",
"Link button will point to (used only in splash).",
"Click to see more",
"Click to read more",
"Filter by:",
"Subject",
...
"Not Found",
"Page not found!",
"We are sorry. We couldn't find the page you were looking for. Please review your url address.",
'');
