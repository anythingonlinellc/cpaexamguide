...
class PeThemeViewLayoutModuleNestorTeamMembers extends PeThemeViewLayoutModuleContainer {

	public function messages() {
		return
			array(
				  "title" => "",
				  "type" => __("Team Members",'Pixelentity Theme/Plugin')
				  );
	}
	...
	public function name() {
		return __("Team Members",'Pixelentity Theme/Plugin');
	}
	...
	public function template() {
		peTheme()->get_template_part("viewmodule",empty($this->data->layout) ? "teammembers" : $this->data->layout);
	}
