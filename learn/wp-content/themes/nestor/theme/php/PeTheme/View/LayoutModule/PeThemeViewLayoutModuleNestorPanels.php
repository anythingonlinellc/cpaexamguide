...
class PeThemeViewLayoutModuleNestorPanels extends PeThemeViewLayoutModuleContainer {

	public function messages() {
		return
			array(
				  "title" => "",
				  "type" => __("Panels",'Pixelentity Theme/Plugin')
				  );
	}
	...
	public function name() {
		return __("Panels",'Pixelentity Theme/Plugin');
	}
	...
	public function template() {
		peTheme()->get_template_part("viewmodule",empty($this->data->layout) ? "panels" : $this->data->layout);
	}

	public function tooltip() {
		return __("Use this block to add a Panels section.",'Pixelentity Theme/Plugin');
	}
